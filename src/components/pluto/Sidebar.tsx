...
const items = [
  ...
  { to: "/dashboard/pluto-schema", label: "Pluto Schema", icon: Boxes },
  { to: "/dashboard/pluto-migrations", label: "Pluto Migrations", icon: GitBranch },
  { to: "/dashboard/pluto-backups", label: "Pluto Backups", icon: Archive },
  { to: "/dashboard/pluto-webhooks", label: "Pluto Webhooks", icon: Package },
  { to: "/dashboard/pluto-search", label: "Pluto Search & Vector", icon: Search },
  { to: "/dashboard/pluto-billing", label: "Pluto Billing & Alerts", icon: GaugeAlt },
  { to: "/dashboard/pluto-branches", label: "Pluto Branches", icon: GitBranch },
  { to: "/dashboard/pluto-graphql", label: "Pluto GraphQL", icon: Sparkles },
  { to: "/dashboard/pluto-sdk", label: "Pluto CLI & SDK", icon: Terminal },
  { to: "/dashboard/pluto-auth-advanced", label: "Pluto Auth (OAuth/MFA/SSO)", icon: Shield },
  { to: "/dashboard/pluto-orgs", label: "Pluto Orgs & Teams", icon: Building2 },
  { to: "/dashboard/pluto-realtime", label: "Pluto Realtime & Presence", icon: Radio },
  { to: "/dashboard/pluto-storage-plus", label: "Pluto Storage v2", icon: Files },
  { to: "/dashboard/pluto-functions-plus", label: "Pluto Cron & Logs", icon: Cloud },
  { to: "/dashboard/pluto-queues", label: "Pluto Queues & Jobs", icon: Waves },
